...
# --- IMPORTANT ---
# This must match the name of your app's folder
# -----------------
...
REPO_DIR = os.path.join(os.getcwd(), REPO_FOLDER_NAME)
...
def handle_webhook():
    ...
    try:
        ...
        result = subprocess.run(
            ...
            text=True,
            check=True,
            cwd=REPO_DIR  # Run script from inside the repo folder
        )
        print(result.stdout)
...
if __name__ == '__main__':
    # Runs on port 5001 so it doesn't conflict with your app
